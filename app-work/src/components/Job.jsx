...
/*showDetails = true imposta la visibilita della sezione di card dettagli che voglio sia visibile
solo nei risultai di ricerca ma non più nella pagina company*/
const Job = ({ data, showDetails = true }) => {
